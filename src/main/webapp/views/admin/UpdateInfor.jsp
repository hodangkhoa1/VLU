                        ...
                        <form action="${pageContext.request.contextPath}/admin/update-infor" class="templatemo-login-form" method="post">
                            <div class="row form-group">
                                <div class="col-lg-6 col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control" id="inputFirstName" placeholder="First Name" name="FirstName" value="${FIRSTNAME != null ? FIRSTNAME : sessionScope.LOGIN_ADMIN.firstName}">
                                    <div class="message">
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control" id="inputLastName" placeholder="Last Name" name="LastName" value="${LASTNAME != null ? LASTNAME : sessionScope.LOGIN_ADMIN.lastName}">
                                    <div class="message">
                            ...
                            <div class="row form-group">
                                <div class="col-lg-6 col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control" id="inputUsername" placeholder="Username" name="Username" value="${USERNAME != null ? USERNAME : sessionScope.LOGIN_ADMIN.userName}">
                                    <div class="message">
                            ...
                            <div class="row form-group">
                                <div class="col-lg-6 col-md-6 form-group">
                                    ...
                                    <input type="password" class="form-control highlight" id="inputCurrentPassword" placeholder="Current Password" name="CurrentPassword">
                                    <div class="message">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                    ...
                                    <input type="password" class="form-control" id="inputConfirmNewPassword" placeholder="Confirm New Password" name="ConfirmNewPassword">
                                    <div class="message">
